...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_planck_grid(
      KC_TILD, KC_0,    KC_1,     KC_2,     KC_3,    KC_4,    KC_5,    KC_6,     KC_P7, KC_P8,  KC_P9,  KC_PPLS,
      KC_DEL,  KC_HOME, KC_UP,    KC_END,   _______, _______, _______, _______,  KC_P4, KC_P5,  KC_P6,  KC_PMNS,
      _______, KC_LEFT, KC_DOWN,  KC_RIGHT, _______, _______, _______, _______,  KC_P1, KC_P2,  KC_P3,  KC_PAST,
